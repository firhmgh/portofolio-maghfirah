...
import { BrowserRouter, useRouter } from './router';
      ...
      <main id="main-content" className="relative z-10">
        {projectSlug ? (
          project ? (
            ...
            <div className="pt-36 pb-24 px-4 text-center space-y-4">
              ...
              <a
                href="/"
                className="inline-block px-5 py-2.5 rounded-2xl bg-blue-600 text-white text-sm font-bold shadow-md hover:bg-blue-700"
              >
                Back to Homepage
              </a>
            </div>
